...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.load_words_button.grid(row=0, column=0, padx=10, pady=10)
        ...
        self.flashcard = tk.Button(self, width=50, height=10)
        self.flashcard["text"] = "Load words to continue..."
        self.flashcard["state"] = "disabled"
        self.flashcard["command"] = self.flip_text
        self.flashcard.grid(row=1, column=0, columnspan=3, padx=10, pady=10, sticky="ewns")
